...
def naked_twins(values):
    ...
    twins_cand = [box for box in values.keys() if len(values[box]) == 2]
    twin = [[box1, box2] for box1 in twins_cand for box2 in peers[box1] if set(values[box1]) == set(values[box2])]
